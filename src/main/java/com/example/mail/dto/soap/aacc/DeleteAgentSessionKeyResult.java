...
@Data 
@XmlRootElement(name = "DeleteAgentSessionKeyResult", namespace = "")
public class DeleteAgentSessionKeyResult {

    private String AvayaAgentID;
    private String SessionKey;
    private String message;
    
    public DeleteAgentSessionKeyResult() {}

    public DeleteAgentSessionKeyResult(String AvayaAgentID, String SessionKey,String message) {
